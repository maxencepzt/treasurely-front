...
/** La page Paramètres : les pages du profil en liens décrits, puis la session et le compte. */
export default function UserSettings({ user, isOwner }: { user: User; isOwner: boolean; }) {
  ...
  const pages = [
    ...
    { to: `${base}/upload`, label: 'Modifier la photo de profil', hint: 'Une image de 5 Mo au plus' },
  ];

  return (
    <SettingsLayout title="Paramètres de l'utilisateur">
      <section aria-labelledby="settings-profile" className="flex flex-col gap-3">
